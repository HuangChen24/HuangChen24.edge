...
Running Pareto optimization will use the objective.eval_constraint function. 
This function makes the solution.get_value() a vector.
The first element of the vector is the objective function value by objective.__func, 
and the second element is the constraint degree by objective.__constraint
...
import numpy as np
from zoopt.zoopt.utils.zoo_global import gl
from copy import deepcopy
import time
from zoopt.zoopt.utils.tool_function import ToolFunction
