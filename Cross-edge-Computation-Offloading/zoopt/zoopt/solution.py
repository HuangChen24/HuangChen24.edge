...
"""
from zoopt.zoopt.utils.zoo_global import pos_inf, neg_inf, nan, gl
...
and attachment
    ...
    def __init__(self, x=[], value=nan, resample_value=None, attach=None, post_attach=None, is_in_possible_solution=False):
        ...
        :param attach: attached structure.
            ...
            You can define the behavior through rewrite Objective.__inherit function (just do nothing as default).
        ...
        :param post_attach: the attachment to the solution.
            ...
            You can define the behavior through rewrite Objective.__post_inherit function (just do nothing as default).
